 ...
 */
public class MiniGraphicsContext {

	private static final String TAG = "MiniGraphicsContext";
	...
	public MiniGraphicsContext(Canvas canvas) {
		mPen    = new Paint();
	...
	public void drawRect(int l, int t, int w, int h) {
		MiniLog.d(TAG, "java drawRect" + l + t + w + h);
		mCanvas.drawRect(l, t, w + l, t + h, mBrush);
	}

	public void drawText(String s, int x, int y) {
		MiniLog.d(TAG, "java drawText " + s);
	...
	private void drawText(String s, Rect r, int align) {
		MiniUtils.drawText(s, r, align, mCanvas, mPen);
	}
	...
	public void setBrushColor(int color) {
		MiniLog.d(TAG, "java color=" + Integer.toHexString(color));
	...
	public void drawBitmap(MiniBitmap bitmap,			
			int left, 
			int top,
			int width,
			int height) {
		MiniLog.d(TAG, "MiniGraphicsContext.drawBitmap");
		if (bitmap.getBitmap() == null) {
			return;
		}
		
		Matrix matrix = new Matrix();
		MiniLog.d(TAG, "left=" + left + " " + "width="+width+" " + "height="+height + " "
